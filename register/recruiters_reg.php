...
<head>
    ...
    <link rel="stylesheet" href="../static/css/jobseeker_reg.css">
    <title>Recruiters Registeration</title>
</head>
    ...
    <?php include '../header.php'?>
        ...
        <div class="container-contact100">
            <div class="wrap-contact100">
                <form action="recreg.php" class="contact100-form validate-form" method="POST">
